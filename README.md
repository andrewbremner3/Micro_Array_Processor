...
Raw Image .tif file that is the input to the script:       Output image of a processed well:
![Raw Slide Image](https://github.com/andrewbremner3/MicroArrayProcessor/blob/main/ReadMeImages/Whole_Slide.png)

Zoomed in raw image of one of the microarray:
![Raw microarray](https://github.com/andrewbremner3/MicroArrayProcessor/blob/main/ReadMeImages/Raw_Well_Image.png)![Raw microarray](https://github.com/andrewbremner3/MicroArrayProcessor/blob/main/ReadMeImages/Processed_Well_Image.png)
